...
import styles from '@venice/styles/components/LogoAnimation.module.scss'

export const LogoAnimation = () => {
  return (
    <svg
      className={styles.JSMAnimation__logo}
    ...
    >
      <defs>
        ...
        >
          <stop offset="0" stopColor="#c93f2b" />
          <stop offset="1" stopColor="#ab2723" />
        </linearGradient>
        <linearGradient
          id="gradient-green"
          x1="112.38"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#9cb71e" />
          <stop offset=".36" stopColor="#879e23" />
          <stop offset=".74" stopColor="#788c28" />
          <stop offset="1" stopColor="#728529" />
        </linearGradient>
        <linearGradient
          id="gradient-orange"
          x1="76.23"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#ed7004" />
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#0bbbef" />
          <stop offset="1" stopColor="#005f9f" />
        </linearGradient>
      </defs>
      <g>
        <g>
          ...
          <g
            id={styles['part-red']}
            className={classNames(styles['logo__part'])}
          >
            <circle fill="#ab2723" cx="18.25" cy="170.05" r="18.25" />
            <path
              fill="#ab2723"
          ...
          <g
            id={styles['part-orange']}
            className={classNames(styles['logo__part'])}
          >
            <circle fill="#ed7004" cx="173.83" cy="170.05" r="18.25" />
            <path
              fill="#ed7004"
