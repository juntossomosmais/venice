  ...
  >
    ...
    <g>
      <g>
        ...
        />
        <g class="logo__part" id="part-red">
        ...
        <g class="logo__part" id="part-green">
          <path
            fill="#728529"
        ...
        <g class="logo__part" id="part-orange">
        ...
        <g class="logo__part" id="part-blue">
          <path
            fill="#005f9f"
...
export default class LogoAnimation extends Vue {}
</script>

<style lang="scss" scoped>
@import '~@venice/styles/components/LogoAnimation.module.scss';
</style>
