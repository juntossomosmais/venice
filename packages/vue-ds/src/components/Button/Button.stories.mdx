...
<Preview>
  <Story name="Filled" parameters={{ decorators: [withKnobs] }} inline={true}>
    {{
      components: { Button },
      template: `
        <div>
...
<Preview>
  <Story name="Outlined" inline={true}>
    {{
      components: { Button },
      template: `
        <div>
...
<Preview>
  <Story name="Small" parameters={{ decorators: [withKnobs] }} inline={true}>
    {{
      components: { Button },
      template: `
        <div>
...
<Preview>
  <Story name="With Icons" inline={true}>
    {{
      components: { Button },
      template: `
